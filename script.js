document.addEventListener("DOMContentLoaded", () => { // FIXED: Correct arrow function syntax
    ...
    const CLASS_DATA = {
        Sheriff: {
            ...
            abilities: [
                { name: "Under My Protection", type: "Passive", apCost: 0, description: "The Sheriff's vigilance shields nearby Bloodwells...", techDesc: "Bloodwells in 3x3 grid centered on Sheriff are immune to standard Shots (not Hand Cannon)." },
                { name: "Swift Justice", type: "Passive", apCost: 0, description: "Fueled by unwavering purpose, one Sheriff presses forward...", techDesc: "End of Turn: May move one non-cursed Sheriff 1 square forward (0 AP)." },
                { name: "Order Restored", type: "Active", apCost: 3, description: "Even true death cannot halt the Sheriff's decree!...", techDesc: "1/game: Revive one eliminated Sheriff adjacent to own Vamp/BW." },
            ],
        },
        Vigilante: {
            ...
            abilities: [
                { name: "Side by Side", type: "Passive", apCost: 0, description: "Bound by blood and vengeance, this driven pair acts as one...", techDesc: "Player's AP pool is shared between both Vampires." },
                { name: "Blood Brothers", type: "Passive", apCost: 0, description: "Their shared purpose empowers their dark bond when near...", techDesc: "Start of Turn: +1 AP if Vamps are within 3x3 grid and both act this turn." },
                { name: "Vengeance is Mine", type: "Active", apCost: 0, description: "Harm my kin, feel my wrath tenfold!...", techDesc: "1/game: After own piece is shot, gain 7 AP next turn." },
            ],
        },
        Outlaw: {
            color: "color-outlaw",
            ...
            abilities: [
                { name: "Daring Escape", type: "Passive", apCost: 0, description: "Blast an enemy Bloodwell, then melt into the shadows...", techDesc: "1/turn: After shooting a Bloodwell, may Pivot free & Move up to 2 squares (0 AP)." },
                { name: "Hand Cannon", type: "Active", apCost: 5, description: "Unleash unholy hellfire from a modified Hand Cannon!...", techDesc: "1/game: Piercing shot (max 5 sq), ignores Hazards (unless Sheriff-prot.). Destroys BW/Hazards hit." },
                { name: "Rampage", type: "Active", apCost: 2, description: "Embrace the chaos! The Outlaw spins wildly...", techDesc: "1/game: Shoot simultaneously Left & Right (two standard shots)." },
            ],
        },
        "Bounty Hunter": {
            ...
            abilities: [
                { name: "Sharpshooter", type: "Passive", apCost: 0, description: "Tombstones offer no refuge. This Hunter's unnervingly accurate shots...", techDesc: "Shots ignore Tombstones when determining hit/block." },
                { name: "Marked Man", type: "Passive", apCost: 0, description: "Every bullet carries a debilitating hex...", techDesc: "Standard shots hitting enemy Vamps apply Curse (Move 1/turn, No Shoot/Throw)." },
                { name: "Contract Payoff", type: "Active", apCost: 3, description: "Destroying an enemy Bloodwell brings dark satisfaction...", techDesc: "1/game: If shot destroys any BW, gain +3 AP (2P) / +5 AP (3P/4P) next turn." },
            ],
        },
    };
    ...
    function getRowColFromCoord(coord) {
        ...
        return { row: rowNum, col: colLetter.charCodeAt(0) - 64 }; // A=1, B=2,... I=9
    }
	...
	3: [
		// --- 3P Layout 1 (4T, 3BW, 3GD) ---
		{
			vampires: [
				...
				{ player: 2, coord: "G8", facing: "W", id: "P3V2" }, // Bottom-Middle/Right
			],
			bloodwells: [
				{ player: 0, coord: "A1", id: "P1BW1" },
				{ player: 0, coord: "C1", id: "P1BW2" },
		...
		// --- 3P Layout 2 (3T, 4BW, 3GD) ---
		{
			vampires: [
				...
				{ player: 2, coord: "G8", facing: "N", id: "P3V2" }, // Bottom
			],
			bloodwells: [
				{ player: 0, coord: "B1", id: "P1BW1" },
		...
		// --- 3P Layout 3 (3T, 3BW, 4GD) ---
		{
			vampires: [
				...
				{ player: 2, coord: "G7", facing: "N", id: "P3V2" }, // South
			],
			bloodwells: [
		...
		// --- 3P Layout 4 (4T, 4BW, 2GD) ---
		{
			vampires: [
				...
				{ player: 2, coord: "E6", facing: "N", id: "P3V2" }, // Bottom-Middle
			],
			bloodwells: [
				{ player: 0, coord: "A2", id: "P1BW1" },
		...
		// --- 3P Layout 5 (4T, 2BW, 4GD) ---
		{
			vampires: [
				...
				{ player: 2, coord: "G1", facing: "S", id: "P3V2" }, // Top
			],
			bloodwells: [
	...
	4: [
		// --- 4P Layout 1 (4T, 3BW, 3GD) ---
		{
			vampires: [
				...
				{ player: 3, coord: "H8", facing: "N", id: "P4V2" }, // BR
			],
			bloodwells: [
				{ player: 0, coord: "A1", id: "P1BW1" },
		...
		// --- 4P Layout 2 (3T, 4BW, 3GD) ---
		{
			vampires: [
				...
				{ player: 3, coord: "G9", facing: "N", id: "P4V2" }, // BR
			],
			bloodwells: [
		...
		// --- 4P Layout 3 (3T, 3BW, 4GD) ---
		{
			vampires: [
				...
				{ player: 3, coord: "H7", facing: "N", id: "P4V2" }, // Bottom-Rightish
			],
			bloodwells: [
				{ player: 0, coord: "A1", id: "P1BW1" },
				{ player: 0, coord: "C1", id: "P1BW2" },
				...
				{ player: 3, coord: "E8", id: "P4BW3" }, // P4 BW slightly different
			],
			hazards: [
				{ type: "Tombstone", coord: "E4" },
				{ type: "Tombstone", coord: "C6" },
		...
		// --- 4P Layout 4 (4T, 4BW, 2GD) ---
		{
			vampires: [
				...
				{ player: 3, coord: "G9", facing: "W", id: "P4V2" }, // BR Corner
			],
			bloodwells: [
		...
		// --- 4P Layout 5 (2T, 4BW, 4GD) --- *Alternate distribution*
		{
			vampires: [
				...
				{ player: 3, coord: "E9", facing: "N", id: "P4V2" }, // South Mid
			],
			bloodwells: [
...
// --- Turn Management & Specific Abilities ---
	...
	*/
    ...
    if (currentGameState.board?.vampires) {
	 currentGameState.board.vampires.forEach((v) => { if(v) v.movesThisTurn = 0; });
    }
...
// Next batch will start with Initialization (initializeGame).
                ...
                if (currentPlayerSetupIndex > 0) {
                    ...
                    for (let i = 0; i < newPlayerIndex; i++) { // Only loop up to *before* newPlayerIndex
                     ...
                     for(let i = newPlayerIndex + 1; i < playerData.length; i++){
                          if(playerData[i]) playerData[i] = { name: `P${i + 1}`, class: null };
                     }
        ...
        if (btnHandCannon) {
            btnHandCannon.addEventListener("click", () => {
                 ...
                 } else { addToLog("Select an Outlaw for Hand Cannon."); }
            });
        }
         if (btnContractPayoff) {
             btnContractPayoff.addEventListener("click", () => {
                 ...
                 } else { addToLog("Select a Bounty Hunter for Contract Payoff."); }
             });
        }
        if (btnOrderRestored) {
             btnOrderRestored.addEventListener("click", () => {
                 const selectedVamp = findVampireById(currentGameState?.selectedVampireId);
                  ...
                  } else { addToLog("Select a Sheriff for Order Restored."); }
             });
        }
        if (btnVengeance) {
             btnVengeance.addEventListener("click", () => {
                 ...
                 } else { addToLog("Select a Vigilante for Vengeance."); }
            });
        }
        ...
        if (btnSwiftJusticeYes) {
            btnSwiftJusticeYes.addEventListener('click', () => {
                ...
                if (swiftJusticePlayerIndex === -1 || !swiftJusticeVampId || currentGameState.players[swiftJusticePlayerIndex]?.class !== 'Sheriff') {
                     ...
                     isSwiftJusticeMovePending = false; swiftJusticePlayerIndex = -1; swiftJusticeVampId = null;
        ...
        } else { console.warn("Swift Justice YES button (#btn-swift-justice-yes) not found"); }
        ...
        if (btnSwiftJusticeNo) {
         ...
         } else { console.warn("Swift Justice NO button (#btn-swift-justice-no) not found"); }
        ...
        } else { console.warn("Elimination popup close button not found"); }
        ...
        } else { console.warn("Victory popup restart button not found"); }
