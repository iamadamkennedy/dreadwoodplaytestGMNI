document.addEventListener("DOMContentLoaded", () =>{
  ...
  function displayClassDetails(className) {
    ...
    .grid - square.invalid - target ").forEach((el) => el.classList.remove("valid - target ", "invalid - target "));
    }
  ...
  function executeShoot(vampire, isSilverBullet = false, overrideFacing = null, apCostOverride = null) {
     ...
     */
              ...
              function initializeGame() {
                ...
                if (!layouts ? .length) {
                  alert(`Error: No layouts defined
                  for $ {
                    numberOfPlayers
                  }
                  players ! `);
                ...
                currentGameState = {
                  ...
                  playerResources: playerData.map(() =>({
                    ...
                    // For Vigilante Vengeance trigger
                    contractPayoffNextTurnBonus: 0,
                    // AP bonus for BH next turn
                    vengeanceNextTurnBonus: 0,
                    // AP bonus for Vigilante next turn
                  })),
                  turn: 1,
                  ...
                  eliminatedVampires: [],
                  // Global list to track for Sheriff revive
                };
                ...
                console.log(` * **Calculated Initial AP: $ {
                  currentGameState.currentAP
                } (
                for player index $ {
                  pIdx
                ...
                // ... rest of function
                logList.innerHTML = ` < li > Game Started: $ {
                  layoutName
                } < /li>`;
        gameLog.scrollTop = 0;
        btnUndo.disabled = true;
